...
module.exports.run = async (client, msg, args, throwE) => {
  ...
  if (!msg.member.hasPermission("KICK_MEMBERS") || !msg.author.id == "472923135965003786" || !msg.author.id == "299314446428274689" || !msg.author.id == "242775871059001344"){
  ...
  if(args[0] == "none") {
      ...
      msg.reply("Cleared the member log channel.")
  }else{
  let channelID = args.join(" ").substring(2, 20);
  serverConf.member[msg.guild.id] = {
      member: channelID
    };
    msg.reply("Set <#" + serverConf.member[msg.guild.id].member + "> as the member log channel.");
}
...
exports.help = {
  name: 'setmemberlog',
  description: 'Sets your member log channel (use \'none\' to clear)',
  usage: 'nva:setmemberlog #channel-name',
